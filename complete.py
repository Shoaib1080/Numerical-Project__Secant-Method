...
print("Enter the function in terms of x (e.g., sin(x) - x/2):")
func_input = input("f(x) = ")

x0_input = float(input("Enter initial guess x0: "))
x1_input = float(input("Enter initial guess x1: "))
n_input = int(input("Enter number of iterations: "))

# Call the secant method with user input
secantmethod(func_input, x0_input, x1_input, n_input)
